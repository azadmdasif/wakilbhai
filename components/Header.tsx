        ...
        <div className="flex h-16 items-center justify-between sm:h-20">
          <div className="flex-shrink-0">
            <Link href={href('/')} className="flex items-center gap-2 sm:gap-3">
              <Image src="/logo.png" alt="WakilBhai Logo" width={56} height={56} className="h-10 w-auto sm:h-14" />
              <span className="font-display text-xl font-bold tracking-wider sm:text-2xl">
          ...
          {/* Mobile: compact language picker stays in the top bar (always reachable,
              no full-width strip) next to the menu toggle. */}
