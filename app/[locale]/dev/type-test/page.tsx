...
const SAMPLES: Record<Locale, Sample> = {
  ...
  mr: {
    heading: 'चेक बाउन्स झाला? काय करावे',
    body: 'बँकेचा रिटर्न मेमो मिळाल्यापासून 30 दिवसांत लेखी डिमांड नोटीस पाठवा. त्यानंतर देणाऱ्याला पैसे भरण्यासाठी 15 दिवस मिळतात, अन्यथा कलम 138 अंतर्गत तक्रार दाखल होऊ शकते.',
    chip: '30 दिवस',
    money: '₹45,000 · अद्ययावत 15 जुलै 2026',
  },
  te: {
    heading: 'చెక్ బౌన్స్ అయిందా? ఏమి చేయాలి',
    body: 'బ్యాంకు రిటర్న్ మెమో అందిన 30 రోజుల్లోపు లిఖితపూర్వక డిమాండ్ నోటీసు పంపండి. ఆ తర్వాత చెల్లించవలసిన వ్యక్తికి చెల్లించడానికి 15 రోజులు ఉంటాయి, లేకపోతే సెక్షన్ 138 కింద ఫిర్యాదు దాఖలు చేయవచ్చు.',
    chip: '30 రోజులు',
    money: '₹45,000 · నవీకరణ 15 జూలై 2026',
  },
  ta: {
    heading: 'காசோலை பவுன்ஸ் ஆனதா? என்ன செய்வது',
    body: 'வங்கியின் ரிட்டர்ன் மெமோ கிடைத்த 30 நாட்களுக்குள் எழுத்துப்பூர்வ கோரிக்கை நோட்டீஸ் அனுப்புங்கள். பிறகு தரவேண்டியவருக்கு செலுத்த 15 நாட்கள் உள்ளன, இல்லையெனில் பிரிவு 138-இன் கீழ் புகார் அளிக்கலாம்.',
    chip: '30 நாட்கள்',
    money: '₹45,000 · புதுப்பிப்பு 15 ஜூலை 2026',
  },
  gu: {
    heading: 'ચેક બાઉન્સ થયો? શું કરવું',
    body: 'બેંકનો રિટર્ન મેમો મળ્યાના 30 દિવસમાં લેખિત ડિમાન્ડ નોટિસ મોકલો. પછી ચૂકવનારને ચૂકવવા માટે 15 દિવસ મળે છે, નહીંતર કલમ 138 હેઠળ ફરિયાદ દાખલ કરી શકાય.',
    chip: '30 દિવસ',
    money: '₹45,000 · અપડેટ 15 જુલાઈ 2026',
  },
};
